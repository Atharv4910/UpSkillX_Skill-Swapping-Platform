...
public class Feed extends Application{
    ...
    public void setFeedStage(Stage stage) {
        this.feedStage = stage;
    }
    ...
    public void start(Stage mystage) throws Exception{
      HBox topBar = new HBox(10);
        ...
        backBtn.setStyle("-fx-background-color:#8E24AA;-fx-background-radius:5;-fx-font-weight: bold;");
        ...
        topBar.getChildren().addAll(backBtn, spacer1, feedTitle, spacer2, postBtn);
